...
public class CellStyleCache
{
    ...
    private String getRepresentation(CellStyle cs, Font f)
    {
        ...
        return getRepresentation(f.getBold(), f.getItalic(), fontColor, f.getFontName(),
                f.getFontHeightInPoints(), cs.getAlignment().getCode(), cs.getBorderBottom().getCode(), cs.getBorderLeft().getCode(), cs.getBorderRight().getCode(),
                cs.getBorderTop().getCode(), cs.getDataFormatString(), f.getUnderline(), f.getStrikeout(), cs.getWrapText(),
                cs.getFillBackgroundColorColor(), cs.getFillForegroundColorColor(), cs.getFillPattern().getCode(), cs.getVerticalAlignment().getCode(),
