...
public class StyleTag extends BaseTag
{
    ...
    private void examineAndApplyStyle(Workbook workbook, Cell cell)
    {
        ...
        short alignment = (myStyle.getAlignment() != null) ? myStyle.getAlignment().getIndex() : cs.getAlignment().getCode();
        short borderBottom = (myStyle.getBorderBottomType() != null) ? myStyle.getBorderBottomType().getIndex() : cs.getBorderBottom().getCode();
        short borderLeft = (myStyle.getBorderLeftType() != null) ? myStyle.getBorderLeftType().getIndex() : cs.getBorderLeft().getCode();
        short borderRight = (myStyle.getBorderRightType() != null) ? myStyle.getBorderRightType().getIndex() : cs.getBorderRight().getCode();
        short borderTop = (myStyle.getBorderTopType() != null) ? myStyle.getBorderTopType().getIndex() : cs.getBorderTop().getCode();
        ...
        short fillPattern = (myStyle.getFillPatternType() != null) ? myStyle.getFillPatternType().getIndex() : cs.getFillPattern().getCode();
        ...
        short verticalAlignment = (myStyle.getVerticalAlignment() != null) ?
                myStyle.getVerticalAlignment().getIndex() : cs.getVerticalAlignment().getCode();
        boolean wrapText = (myStyle.isWrappingText() != null) ? myStyle.isWrappingText() : cs.getWrapText();
        boolean fontBoldweight = (myStyle.getFontBoldweight() != null) ? (myStyle.getFontBoldweight() == FontBoldweight.BOLD? true: false) : f.getBold();
