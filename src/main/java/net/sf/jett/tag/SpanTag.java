...
import org.apache.poi.ss.usermodel.CellStyle; import org.apache.poi.ss.usermodel.BorderStyle;
...
//      long start = System.nanoTime();
        ...
        short borderBottomType = BorderStyle.NONE.getCode();
        short borderLeftType = BorderStyle.NONE.getCode();
        short borderRightType = BorderStyle.NONE.getCode();
        short borderTopType = BorderStyle.NONE.getCode();
        ...
        if (rTop != null)
        {
            ...
            if (cLeft != null)
            {
                ...
                borderLeftType = cs.getBorderLeft().getCode();
                borderTopType = cs.getBorderTop().getCode();
        ...
        if (rBottom != null)
        {
            ...
            if (cRight != null)
            {
                ...
                borderRightType = cs.getBorderRight().getCode();
                borderBottomType = cs.getBorderBottom().getCode();
                // Border colors need instanceof check.
                if (cs instanceof HSSFCellStyle)
                {
        ...
        if (borderTopType != BorderStyle.NONE.getCode() || borderBottomType != BorderStyle.NONE.getCode() ||
                borderRightType != BorderStyle.NONE.getCode() || borderLeftType != BorderStyle.NONE.getCode())
        {
            ...
            for (int c = left; c <= right; c++)
            {
                ...
                if (cell != null)
                {
                    ...
                    CellStyle foundStyle = csCache.retrieveCellStyle(f.getBold(), f.getItalic(), fontColor,
                            f.getFontName(), f.getFontHeightInPoints(), cs.getAlignment().getCode(), BorderStyle.NONE.getCode(),
                            BorderStyle.NONE.getCode(), BorderStyle.NONE.getCode(), BorderStyle.NONE.getCode(), cs.getDataFormatString(),
                            f.getUnderline(), f.getStrikeout(), cs.getWrapText(), cs.getFillBackgroundColorColor(),
                            cs.getFillForegroundColorColor(), cs.getFillPattern().getCode(), cs.getVerticalAlignment().getCode(), cs.getIndention(),
                            cs.getRotation(), null, null, null, null,
                            f.getCharSet(), f.getTypeOffset(), cs.getLocked(), cs.getHidden());

                    if (foundStyle == null)
                    {
                        foundStyle = SheetUtil.createCellStyle(sheet.getWorkbook(), cs.getAlignment().getCode(), BorderStyle.NONE.getCode(),
                                BorderStyle.NONE.getCode(), BorderStyle.NONE.getCode(), BorderStyle.NONE.getCode(), cs.getDataFormatString(),
                                cs.getWrapText(), cs.getFillBackgroundColorColor(), cs.getFillForegroundColorColor(),
                                cs.getFillPattern().getCode(), cs.getVerticalAlignment().getCode(), cs.getIndention(), cs.getRotation(),
                                ...
                                Color borderLeftColor, Color borderRightColor, Color borderTopColor, Color borderBottomColor)
    {
        ...
        for (int r = top; r <= bottom; r++)
        {
            ...
            for (int c = left; c <= right; c++)
            {
                ...
                short newBorderBottom = (r == bottom) ? borderBottom: BorderStyle.NONE.getCode();
                short newBorderLeft = (c == left) ? borderLeft : BorderStyle.NONE.getCode();
                short newBorderRight = (c == right) ? borderRight : BorderStyle.NONE.getCode();
                short newBorderTop = (r == top) ? borderTop : BorderStyle.NONE.getCode();
                ...
                // characteristics.  Find a CellStyle if it exists.
                CellStyle foundStyle = csCache.retrieveCellStyle(f.getBold(), f.getItalic(), fontColor,
                        f.getFontName(), f.getFontHeightInPoints(), cs.getAlignment().getCode(),
                ...
                if (foundStyle == null)
                {
                    foundStyle = SheetUtil.createCellStyle(sheet.getWorkbook(), cs.getAlignment().getCode(), newBorderBottom,
