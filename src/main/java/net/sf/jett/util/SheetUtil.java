...
//   }
                                            ...
                                            Color rightBorderColor, Color topBorderColor, boolean locked, boolean hidden)
    {
        ...
        cs.setAlignment(HorizontalAlignment.forInt(alignment) ); 
        cs.setBorderBottom(BorderStyle.valueOf(borderBottom) ); 
        cs.setBorderLeft(BorderStyle.valueOf(borderLeft));
        cs.setBorderRight(BorderStyle.valueOf(borderRight));
        cs.setBorderTop(BorderStyle.valueOf(borderTop));
        ...
        cs.setVerticalAlignment(VerticalAlignment.forInt(verticalAlignment) );
        ...
        cs.setFillPattern(FillPatternType.forInt(fillPattern));
        return cs;
    }
