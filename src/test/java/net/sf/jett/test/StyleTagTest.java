...
public class StyleTagTest extends TestCase
{
   ...
   protected void check(Workbook workbook)
   {
      ...
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderBottom());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderLeft());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderRight());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 1).getBorderTop());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 3).getBorderBottom());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 5).getBorderLeft());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 7).getBorderRight());
      assertEquals(BorderStyle.MEDIUM_DASH_DOT.ordinal(), TestUtility.getCellStyle(border, 25, 9).getBorderTop());
