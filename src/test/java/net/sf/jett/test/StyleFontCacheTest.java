...
public class StyleFontCacheTest extends TestCase
{
    ...
    private void testCellStyleCache(Workbook workbook)
    {
        ...
        // Defaults.
        short alignment = cs.getAlignment().getCode();
        short borderBottom = cs.getBorderBottom().getCode();
        short borderLeft = cs.getBorderLeft().getCode();
        short borderRight = cs.getBorderRight().getCode();
        short borderTop = cs.getBorderTop().getCode();
        ...
        short fillPattern = cs.getFillPattern().getCode();
        ...
        short verticalAlignment = cs.getVerticalAlignment().getCode();
        ...
        short newAlignment = HorizontalAlignment.RIGHT.getCode();
        // Expect a cache miss.
